...
class HTML_DOM {
    ...
    {
        log_message('debug', "HTML_DOM Class Initialized");
    }
...
// helper functions
     ...
     * @param $url
     * @param $use_include_path = false
     * @param $context=null
     * @param $offset = -1
     * @param $maxLen=-1 defined in the code as PHP_STREAM_COPY_ALL which is defined as -1.
     * @param $lowercase = true
     * @param $forceTagsClosed=true
     * @param $target_charset = DEFAULT_TARGET_CHARSET
     * @param $stripRN=true
     * @param $defaultBRText=DEFAULT_BR_TEXT
     * @param $defaultSpanText=DEFAULT_SPAN_TEXT
     */
